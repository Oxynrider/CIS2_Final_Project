...
public class EntityLightningBlast extends EntityThrowable {

	public static final float explosionPower = 5F;
		 
		    public EntityLightningBlast(World world)
		    {
		        super(world);
		    }
		 
		    public EntityLightningBlast(World world, EntityLivingBase entity)
		    {
		        super(world, entity);
		    }
		    ...
		    private void explode()
		    {
		        ...
		        worldObj.createExplosion(this, bx, by, bz, 2F, true);
		        this.setDead();
		    }
		    @Override
