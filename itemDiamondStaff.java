...
public class itemDiamondStaff extends Item{
	public static final Item DiamondStaff= new itemDiamondStaff();
    public static final String[] chargeStaffArray = new String[] {"chrg1","chrg2","chrg3"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

	public itemDiamondStaff()
    {       
        ...
        this.setUnlocalizedName("Diamond Staff");
...
*/	@Override
    ...
    public void onPlayerStoppedUsing(ItemStack itemStack, World world, EntityPlayer player, int charge)
    {
        ...
        if (j>=30){
        	world.spawnEntityInWorld(new EntityLightningBlast(world, player));
        	itemStack.damageItem(1,player);
        }
        //j = event.charge;
    }
