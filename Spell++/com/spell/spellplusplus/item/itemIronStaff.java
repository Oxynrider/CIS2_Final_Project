...
public class itemIronStaff extends Item{
	public static final Item IronStaff= new itemIronStaff();
   ...
   // public static final String[] bowPullIconNameArray = new String[] {"pulling_0", "pulling_1", "pulling_2"};
	...
	//IronStaff=new itemIronStaff();


	public itemIronStaff()
    {       
		this.setCreativeTab(CreativeTabs.tabCombat);
        this.setMaxStackSize(1);
        this.setMaxDamage(0);
        this.setTextureName(SpellPlusPlus.MODID + ":wandIron");
        this.setUnlocalizedName("Iron Staff");
    }
...
*/
    ...
    public void onPlayerStoppedUsing(ItemStack itemStack, World world, EntityPlayer player, int charge)
    {
        ...
        if (j>=25){
        	world.spawnEntityInWorld(new EntityIronBolt(world, player));
        	itemStack.damageItem(1,player);
        }
