...
public class EntityStoneBolt extends EntityThrowable {
 /*
public static float explosionRadius = 1.0F;
 
public EntityStoneBolt(World par1World)
    {
        super(par1World);
    }
    public EntityStoneBolt(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World, par2EntityLivingBase);
    }
    public EntityStoneBolt(World par1World, double par2, double par4, double par6)
    {
 ...
 */
	public static final float explosionPower = 5F;
		    ...
		    public EntityStoneBolt(World world, EntityLivingBase entity)
		    {
		        super(world, entity);
		    }
		    ...
		    private void explode()
		    {
		        ...
		        worldObj.setBlock((int)posX, (int)posY, (int)posZ,Blocks.cobblestone);
		        this.setDead();
		    }
		    @Override
